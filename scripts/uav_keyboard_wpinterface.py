...
if __name__ == "__main__":
    ...
    curGoal = {'lat': 47.3978614807, 'long': 8.54560279846, 'alt': 11.0} 
    wpPushRequest.waypoints.append(createTakeoffCurr(curGoal['lat'], curGoal['long'], curGoal['alt']))
    rospy.sleep(1)
	...
	wpPushRequest.waypoints.append(createWaypoint(radius,curGoal['lat'], curGoal['long'], curGoal['alt']))
	print(waypointPushService.call(wpPushRequest))
